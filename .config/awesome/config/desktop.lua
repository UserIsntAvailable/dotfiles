...
client.connect_signal(
    ...
    function(c) -- Hacky way of having gradiant borders ( Actually recommended by Awesome team )
        ...
        local grad_normal = {
            type  = "linear",
            from  = { 0, 0 }, to = { 0, c:geometry().height },
        ...
        awful.titlebar(c, {
            position = 'top', size = width,
            bg_normal = col1_normal, bg_focus = col1_active
        })
        awful.titlebar(c, {
            position = 'bottom', size = width,
            bg_normal = col2_normal, bg_focus = col2_active
        })
        awful.titlebar(c, {
            position = 'left', size = width,
            bg_normal = grad_normal, bg_focus = grad_active
        })
        awful.titlebar(c, {
