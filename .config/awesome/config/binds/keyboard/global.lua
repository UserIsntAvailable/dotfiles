...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ mod_key }, "v", function()
        awful.spawn("neovide")
    end, { description = "run GUI vim", "launcher" }),
    awful.key({ mod_key }, "b", function()
        awful.spawn("firefox")
    end, { description = "run browser", "launcher" }),
    ...
    awful.key({ mod_key }, "s", function()
        ...
        description = "makes an screenshot of the monitor that is active",
        group = "launcher",
    }),
    awful.key({ mod_key, "Shift" }, "s", function()
        awful.spawn("flameshot gui")
    end, { description = "run a screenshot tool", group = "launcher" }),
})
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({
        modifiers = { mod_key, "Control", "Shift" },
        keygroup = "numrow",
